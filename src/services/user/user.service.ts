...
import {  schema, userSchemas } from "./schemas/user.schema";
...
export function createUserService(client: GraphQLClient) {
  ...
  return {
    ...
    async getUserGlobalRank(
      ...
      const res = await client.request<{ sendOTP: IMeResponse }, IGetUserGlobalRankRequest>(
        userSchemas.getUserGlobalRank(
          gqlQueryStringBuilder<IMeResponse, IGetUserGlobalRankResponseNestedFields>(
            fetchFields?.root ?? getUserGlobalRank,
    ...
    async getUser(
      ...
      const res = await client.request<{ sendOTP: IMeResponse }, IGetUserRequest>(
        userSchemas.getUser(
          gqlQueryStringBuilder<IMeResponse, IGetUserResponseNestedFields>(
            fetchFields?.root ?? getUser,
